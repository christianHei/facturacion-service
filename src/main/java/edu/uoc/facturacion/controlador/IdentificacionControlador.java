...
@Api(value = "Servicio Identificacion")
public class IdentificacionControlador {
    ...
    @GetMapping(path = "/{nombreUsuario}/{clave}/{rucEmpresa}", produces = "application/json")
    @ResponseBody
    @ApiOperation(value = "Encuentra un Usuario por nombre de usuario, clave y empresa", notes = "Retorna un Usuario")
    public Usuario obtenerPorNombreUsuarioClaveRucEmpresa(@PathVariable("nombreUsuario") String nombreUsuario, @PathVariable("clave") String clave,
                                                          @PathVariable("rucEmpresa") String rucEmpresa) {
        return usuarioServicio.obtenerPorNombreUsuarioClaveRucEmpresa(nombreUsuario, clave, rucEmpresa);
    }
    ...
    @GetMapping(path = "/nombre_usuario/{nombreUsuario}", produces = "application/json")
    @ResponseBody
    ...
    public Usuario obtenerPorNombreUsuario(@PathVariable("nombreUsuario") String nombreUsuario) {
        return usuarioServicio.obtenerPorNombreUsuario(nombreUsuario);
    }
}
